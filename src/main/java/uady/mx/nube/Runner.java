 ...
 * 
 * private final RabbitTemplate rabbitTemplate; private final Receiver receiver;
 * 
 ...
 * rabbitTemplate.convertAndSend(Application.topicExchangeName,
 * "fmat.aplicaciones.nube", "Hello from RabbitMQ!");
